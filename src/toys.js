...
export const TOOLS = [
  ...
  },
  {
    ...
    file: 'meeple.svg',
    label: 'Meeple',
    iconUrl: 'toy/meeple.svg',
    layer:   'toys',
    defaults: { fill: '#e8d800', size: 1, orientation: 1 },
    options: [
      { kind: 'color-hsl', key: 'fill', label: 'Meeple color', show: ['add', 'edit', 'addQuick'] },
      { kind: 'number', key: 'size', label: 'Size', min: 1, max: 2, step: 1, show: ['add'] },
      { kind: 'number', key: 'orientation', label: 'Orientation', min: 1, max: 2, step: 1, show: ['add'] },
    ],
  },
  {
    name:    'chip',
